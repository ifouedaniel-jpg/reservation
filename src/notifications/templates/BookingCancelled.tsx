...
export default function BookingCancelled({ booking }: { booking: BookingSnapshot }) {
      ...
      <Body style={s.body}>
        <Container style={s.container}>
          ...
          <Section style={s.content}>
            <Text style={s.h1}>Réservation annulée</Text>
            <Text style={s.p}>Bonjour {booking.customerFirstName},</Text>
            <Text style={s.p}>
              Votre réservation pour <strong>{booking.service.name}</strong> le{' '}
